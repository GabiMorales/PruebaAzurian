 ...
 */
package com.gabrielmorales.pruebaazuriangm.service;

import com.gabrielmorales.pruebaazuriangm.Persona;
 ...
 */
@Stateless
@Path("com.gabrielmorales.pruebaazuriangm.persona")
public class PersonaFacadeREST extends AbstractFacade<Persona> {

    @PersistenceContext(unitName = "com.GabrielMorales_PruebaAzurianGM_war_1.0-SNAPSHOTPU")
